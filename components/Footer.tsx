      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-neutral-400">
              ...
              <li><Link to={getModePath('/rewards')} className="text-brand-accent font-bold hover:underline transition-colors flex items-center gap-1.5">Rewards Vault <span className="text-[9px] bg-brand-accent text-black px-1.5 py-0.2 rounded-full font-black uppercase">New</span></Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-neutral-400">
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:support@propxwealth.com" className="hover:text-brand-accent transition-colors">support@propxwealth.com</a>
              </li>
              <li className="flex items-center gap-2">
            ...
            <div className="flex gap-3 mt-6">
              <a href="https://x.com/PROPxWEALTHx" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-lg bg-white/[0.04] border border-white/[0.08] flex items-center justify-center text-neutral-500 hover:text-brand-accent hover:border-brand-accent/30 transition-all"><Twitter size={14} /></a>
              <a href="https://discord.gg/propxwealth" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-lg bg-white/[0.04] border border-white/[0.08] flex items-center justify-center text-neutral-500 hover:text-brand-accent hover:border-brand-accent/30 transition-all"><DiscordIcon /></a>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-neutral-900 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-neutral-600 text-sm">
            © 2026 PROPxWEALTH. All rights reserved.
          </p>
