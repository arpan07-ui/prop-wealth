        ...
        <div className="min-h-screen bg-black pt-24">
            ...
            <section className="py-24 relative overflow-hidden">
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                    <div className="inline-flex items-center gap-2 bg-brand-gold/[0.08] border border-brand-gold/20 rounded-full px-5 py-2 mb-8">
                        ...
                        <span className="text-xs font-bold text-brand-gold uppercase tracking-widest">About PROPxWEALTH</span>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-4 text-neutral-400 text-sm leading-relaxed">
                                ...
                                <p>
                                    That's when <strong className="text-brand-gold">PROPxWEALTH</strong> was born — a single platform where traders can compare every major firm side-by-side, access verified payout data, read real community reviews, and save money with exclusive deals. All for free.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            {[
                                ...
                                { year: '2024', title: 'The Build', desc: 'Built PROPxWEALTH from scratch — aggregating data from 50+ firms, creating TrustGuard™ algorithm.', icon: <Zap size={18} /> },
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                        {[
                            ...
                            },
                            {
                                ...
                                desc: "PROPxWEALTH is 100% free and always will be. Every trader deserves access to quality data, regardless of account size or experience level.",
            ...
            <section className="py-20 relative">
                ...
                <div className="max-w-3xl mx-auto px-4 text-center">
                    ...
                    <p className="text-neutral-400 text-sm mb-8 max-w-lg mx-auto">Join 50,000+ traders who trust PROPxWEALTH to compare, save, and get funded — all for free.</p>
