...
export default function WealthReplayDashboard() {
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
                        ...
                        <div className="lg:col-span-7 text-left">
                            <div className="inline-flex items-center gap-3 bg-white/[0.03] border border-brand-gold/20 rounded-full pl-3 pr-5 py-2 mb-8 backdrop-blur-xl shadow-[0_0_25px_-5px_rgba(246,174,19,0.2)] hover:border-brand-gold/50 transition-all cursor-default animate-fade-in-up md:mt-10">
                                ...
                                <span className="text-xs font-semibold text-brand-gold uppercase tracking-wider">Wealth Replay Engine Live</span>
                            </div>
                            ...
                            <div className="flex flex-col sm:flex-row items-center gap-5 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
                                <a
                                    href="https://REPLAY.PROPXWEALTH.COM/signup"
                                    target="_blank"
                                ...
                                <a
                                    href="https://REPLAY.PROPXWEALTH.COM/login"
                                    target="_blank"
                                    rel="noopener noreferrer"
                ...
                <div className="max-w-[1000px] mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <div className="inline-flex items-center gap-2 bg-brand-gold/[0.08] border border-brand-gold/20 rounded-full px-4 py-1.5 mb-5 backdrop-blur-sm">
                            ...
                            <span className="text-xs font-bold text-brand-gold uppercase tracking-widest">Why Wealth Replay</span>
                        </div>
                        <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white tracking-tight mb-4">
                                    ...
                                    <tr className="border-b border-white/5">
                                        ...
                                        <th className="text-center p-5">
                                            <div className="flex flex-col items-center gap-1">
                                                <span className="text-brand-gold font-black text-lg">Wealth Replay</span>
                        ...
                        <div className="bento-feature relative rounded-[24px] overflow-hidden group">
                            ...
                            <div className="relative z-10 p-8 lg:p-10 flex flex-col h-full">
                                ...
                                <div className="mb-6">
                                    ...
                                    <h3 className="text-2xl font-black text-white mb-1">Wealth Basic</h3>
                        ...
                        <div className="bento-feature relative rounded-[24px] overflow-hidden group">
                            ...
                            <div className="relative z-10 p-8 lg:p-10 flex flex-col h-full">
                                ...
                                <div className="mb-6">
                                    ...
                                    <h3 className="text-2xl font-black text-brand-gold mb-1">Wealth Exclusive</h3>
                                    <div className="flex items-baseline gap-1">
                                ...
                                >
                                    ...
                                    <span className="relative flex items-center gap-2">
                                        Start Wealth Exclusive <ArrowRight size={16} className="group-hover/btn:translate-x-1 transition-transform" />
                                    </span>
                                </a>
                            </div>
                        </div>
            ...
            <section className="py-24 relative z-20 overflow-hidden bg-[#181611]">
                ...
                <div className="max-w-[900px] mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="space-y-3 mb-20">
                        <FaqItem
                            question="Is Wealth Replay really free?"
                        ...
                        <FaqItem
                            ...
                            answer="No. The TradingView charts are built into Wealth Replay — you don't need a separate TradingView account or subscription. All chart features, indicators, and drawing tools are included."
                        />
                        <FaqItem
                    ...
                    <div className="relative rounded-[28px] overflow-hidden">
                        ...
                        <div className="relative z-10 py-16 px-8 text-center">
                            ...
                            <p className="text-brand-muted text-lg max-w-lg mx-auto mb-8">
                                Join thousands of traders who are sharpening their edge with Wealth Replay. No credit card needed.
                            </p>
