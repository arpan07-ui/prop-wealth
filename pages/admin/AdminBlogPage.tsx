...
const AdminBlogPage: React.FC = () => {
  ...
  const generateAIPost = async () => {
    ...
    const prompt = `
      You are the world's leading SEO Content Director for the prop firm review site "PROPxWEALTH".
      ...
      6. Include a Call-To-Action (CTA) directing the reader to use the "PROPxWEALTH" to compare firms, mentioning the promo code "WEALTHX" for maximum discounts.
      ...
      You must return ONLY a JSON object (no outside text) structured exactly like this:
      {
         ...
         "meta_title": "The exact Google-optimized Title tag (must include PROPxWEALTH)",
                  ...
                  <div className="p-6 bg-[#000000] border border-border-dark rounded-2xl shadow-xl">
                    ...
                    <div className="bg-[#202124] p-5 rounded-xl font-sans border border-white/5">
                      <div className="flex items-center gap-3 mb-1">
                        ...
                        <div>
                           <div className="text-[#e8eaed] text-sm">PROPxWEALTH</div>
                           <div className="text-[#9aa0a6] text-xs">https://propxwealth.com › blog › {editingPost.slug || 'your-slug'}</div>
                        </div>
                      </div>
