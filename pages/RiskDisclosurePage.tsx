...
const RiskDisclosurePage: React.FC = () => {
    const sections = [
        ...
        { title: '7. User Responsibility', content: 'You are solely responsible for your trading decisions and any resulting financial outcomes. PROPxWEALTH shall not be liable for any losses, damages, or costs arising from your use of the Platform or your reliance on any information provided herein.' },
        { title: '8. Regulatory Notice', content: 'PROPxWEALTH does not provide regulated financial services. Trading regulations vary by jurisdiction. It is your responsibility to ensure that your trading activities comply with the laws and regulations of your country of residence.' },
        { title: '9. Contact', content: 'If you have any questions about this Risk Disclosure, please contact us at support@propxwealth.com.' },
    ];
                    ...
                    <div className="bg-red-500/5 border border-red-500/20 rounded-2xl p-6 mb-10">
                        <div className="flex items-start gap-3">
                            ...
                            <p className="text-red-400/80 text-sm leading-relaxed">
                                <strong>Important:</strong> Trading involves substantial risk of loss. The information provided on PROPxWEALTH is for comparison and educational purposes only and should not be construed as financial advice. Please read this entire disclosure carefully.
                            </p>
                        </div>
                    </div>
