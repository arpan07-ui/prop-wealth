...
import { ShieldCheck, Sparkles, ArrowLeft, Gift, Zap, CheckCircle2, AlertCircle, Loader2, Award } from 'lucide-react';
...
const SignupPage: React.FC = () => {
    ...
    const handleGoogleSignup = async () => {
        try {
            ...
            setError(err?.message || 'Google sign-up could not be initiated. Please try again.');
    ...
    const handleDiscordSignup = async () => {
        try {
            ...
            setError(err?.message || 'Discord sign-up could not be initiated. Please try again.');
            setLoadingProvider(null);
        }
    };
    ...
    return (
        <div className="min-h-screen bg-[#070605] text-white flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden select-none">
            ...
            <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[500px] bg-gradient-to-tr from-[#F0C41B]/15 via-[#F6AE13]/8 to-transparent rounded-full blur-[140px] pointer-events-none" />
            <div className="absolute top-10 right-10 w-[350px] h-[350px] bg-[#5865F2]/12 rounded-full blur-[130px] pointer-events-none" />
            <div className="absolute bottom-10 left-10 w-[320px] h-[320px] bg-[#F0C41B]/6 rounded-full blur-[110px] pointer-events-none" />
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
                ...
                <div className="flex flex-col items-center text-center mb-8">
                    ...
                    <p className="mt-2 text-sm text-neutral-400 max-w-sm">
                        Join 15,000+ traders. 1-click social signup, zero passwords to remember.
                    </p>
                </div>
                ...
                <div className="relative rounded-3xl bg-[#0e0d0a]/85 backdrop-blur-2xl border border-white/10 hover:border-[#F0C41B]/20 p-6 sm:p-8 shadow-[0_25px_60px_rgba(0,0,0,0.85),0_0_30px_rgba(240,196,27,0.05)] transition-all duration-300">
                    ...
                    {/* Trader Perks Banner inside Card */}
                    <div className="mb-6 p-3.5 rounded-2xl bg-gradient-to-r from-[#F0C41B]/10 to-amber-500/5 border border-[#F0C41B]/20 flex items-center gap-3">
                        <div className="w-9 h-9 rounded-xl bg-[#F0C41B]/20 border border-[#F0C41B]/30 flex items-center justify-center shrink-0 text-[#F0C41B]">
                            <Award size={18} />
                        </div>
                        <div>
                            <div className="text-xs font-bold text-white">Instant Trader Member Perks</div>
                            <div className="text-[11px] text-neutral-400">Exclusive discount codes + Reward Store unlocked</div>
                        </div>
                    </div>
                        ...
                        >
                            ...
                            {loadingProvider === 'google' ? (
                                <>
                                    ...
                                    <span>Creating account via Google...</span>
                                </>
                            ) : (
                                <>
                                    {/* Google G Icon */}
                        ...
                        >
                            ...
                            {loadingProvider === 'discord' ? (
                                <>
                                    ...
                                    <span>Creating account via Discord...</span>
                                </>
                            ) : (
                                <>
                    ...
                    <div className="mt-8 pt-6 border-t border-white/5 space-y-2.5">
                        <div className="flex items-center gap-2.5 text-xs text-neutral-400">
                            <Zap size={14} className="text-[#F0C41B] shrink-0" />
                            <span>Instant setup • Ready in under 5 seconds</span>
                        </div>
                        <div className="flex items-center gap-2.5 text-xs text-neutral-400">
                        ...
                        <div className="flex items-center gap-2.5 text-xs text-neutral-400">
                            ...
                            <span>Access to verified prop firm reviews & deals</span>
                        </div>
                    </div>
                ...
                <div className="mt-6 text-center">
                    <p className="text-[11px] text-neutral-500 max-w-xs mx-auto leading-relaxed">
                        By joining, you agree to PROPxWEALTH's{' '}
