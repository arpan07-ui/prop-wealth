...
const TermsOfServicePage: React.FC = () => {
    const sections = [
        { title: '1. Acceptance of Terms', content: 'By accessing or using PROPxWEALTH ("the Platform"), you agree to be bound by these Terms of Service. If you do not agree, please do not use the Platform. We reserve the right to modify these terms at any time, and your continued use constitutes acceptance of any changes.' },
        { title: '2. Description of Service', content: 'PROPxWEALTH is a comparison and informational platform that helps traders discover, compare, and evaluate proprietary trading firms. We aggregate publicly available data, user reviews, and exclusive discount offers. We are not a financial advisor, broker, or prop trading firm ourselves.' },
        ...
        { title: '6. Limitation of Liability', content: 'PROPxWEALTH shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the Platform, including but not limited to financial losses from trading decisions made based on information found on our Platform.' },
        ...
        { title: '8. Intellectual Property', content: 'All content on PROPxWEALTH, including text, graphics, logos, and software, is the property of PROPxWEALTH or its licensors and is protected by intellectual property laws. You may not reproduce, distribute, or create derivative works without our express permission.' },
        ...
        { title: '10. Governing Law', content: 'These Terms shall be governed by and construed in accordance with the laws of the jurisdiction where PROPxWEALTH operates, without regard to its conflict of law provisions.' },
        { title: '11. Contact', content: 'For questions about these Terms, please contact us at support@propxwealth.com.' },
    ];
