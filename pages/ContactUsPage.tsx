...
const ContactUsPage: React.FC = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        const mailtoLink = `mailto:support@propxwealth.com?subject=${encodeURIComponent(formData.subject)}&body=${encodeURIComponent(`Name: ${formData.name}\nEmail: ${formData.email}\n\n${formData.message}`)}`;
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                        ...
                        <div className="lg:col-span-2 space-y-5">
                            {[
                                { icon: <Mail size={20} />, title: 'Email Us', value: 'support@propxwealth.com', href: 'mailto:support@propxwealth.com' },
